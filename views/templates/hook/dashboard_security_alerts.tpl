...
<ul>
    <li>{l s='Criticité' mod='prestascansecurity'} : {$criticity|ucfirst}</li>
...
<p class=""><a class="btn-generate-report btn btn-default btn-action-module-dash" data-action="generateModulesReport" href="{$module_link}"><span>{l s='Resolve this' mod='prestascansecurity'}</span></a></p>
